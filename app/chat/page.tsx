      ...
      <div className="max-w-4xl mx-auto py-8 px-4 h-[calc(100vh-8rem)] flex flex-col">
        ...
        <div className="text-center mb-5">
          ...
          <p className="text-slate-400 text-sm mt-1">
            Powered by Google Gemini • Ask anything about elections 🗳️
          </p>
        </div>
          ...
          <div className="flex-grow p-5 overflow-y-auto space-y-5">
            ...
            {messages.length === 0 && (
              <div className="h-full flex flex-col items-center justify-center text-center">
                ...
                <p className="text-slate-300 max-w-sm mb-7 text-base">
                  Hello! I am VoteGuide AI. Ask me anything about elections, voting, or civic
                  rights — by text or voice!
                </p>
            ...
            {messages.map((msg, idx) => (
              ...
              >
                ...
                <div
                  className={`max-w-[78%] p-4 rounded-2xl text-sm leading-relaxed whitespace-pre-wrap group ${
                    msg.role === "user"
          ...
          <div className="p-4 border-t border-white/10 bg-slate-950/50">
            ...
            >
              <Input
                ...
                placeholder="Ask about elections, voting, civic rights..."
                className="flex-grow bg-slate-800/60"
                disabled={isLoading}
              />
